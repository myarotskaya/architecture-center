...
- Can you specify your index schema upfront? If not, choose an option that supports updateable schemas.

- Do you need an index only for full-text search, or do you also need rapid aggregation of numeric data and other analytics? If you need functionality beyond full-text search, consider options that support analytics beyond full text search.
...
- Do you need to index data in common document formats such as PDF, Word, PowerPoint, and Excel? f yes, choose an option that provides document indexers.
...
| | Azure Search | ElasticSearch | HDInsight with Solr | SQL Server or SQL Database with full text search | 
| --- | --- | --- | --- | --- | 
